...
public class BasicChunkGenerator extends ChunkGenerator<GenerationSettings> {

    public BasicChunkGenerator(IWorld world, BiomeProvider biomeProvider, GenerationSettings settings) {
